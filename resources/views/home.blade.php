...
@section('content')
    <div class="container mx-auto px-6">
        ...
        <span class="mt-3 text-sm text-gray-500">200+ Productos</span>
        ...
        <div class="flex justify-center">
            <div class="flex rounded-md mt-8">
                <a href="#" class="py-2 px-4 leading-tight bg-white border border-gray-200 text-blue-700 border-r-0 ml-0 rounded-l hover:bg-blue-500 hover:text-white"><span>Anterior</a></a>
                ...
                <a href="#" class="py-2 px-4 leading-tight bg-white border border-gray-200 text-blue-700 rounded-r hover:bg-blue-500 hover:text-white"><span>Siguiente</span></a>
            </div>
        </div>
    </div>
@endsection