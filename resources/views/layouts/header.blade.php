    ...
    <div class="container mx-auto px-6 py-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-end w-full">
                ...
                @auth
                    <button @click="cartOpen = !cartOpen" class="text-gray-600 focus:outline-none mx-4 sm:mx-0 mr-5">
        ...
        <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
            ...
            <input class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Buscar">
        </div>
    </div>
</header>