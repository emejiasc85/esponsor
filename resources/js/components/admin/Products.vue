    ...
    <div>
        ...
        <div class="container mx-auto px-6">
            <div class="flex justify-between">
                ...
                <button @click.prevent="showCreateModal=true" type="button" class="bg-indigo-600 rounded-lg px-4 py-2 text-md text-white tracking-wide font-semibold font-sans">Agregar Producto</button>
            </div>
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="title" v-model="edit.title"  class="px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md py-2 "/>
                                </div>
                                <p v-if="errors.title" class="mt-2 text-sm text-red-500">
                                    {{errors.title[0]}}
                                </p>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="description" v-model="edit.description" rows="3" class="px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" ></textarea>
                                </div>
                                <p v-if="errors.description" class="mt-2 text-sm text-red-500">
                                    {{errors.description[0]}}
                                </p>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="min_price" v-model="edit.min_price"  class="px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md py-2 "/>
                                </div>
                                <p v-if="errors.min_price" class="mt-2 text-sm text-red-500">
                                    {{errors.min_price[0]}}
                                </p>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="stock" v-model="edit.stock"  class="px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md py-2 "/>
                                </div>
                                <p v-if="errors.stock" class="mt-2 text-sm text-red-500">
                                    {{errors.stock[0]}}
                                </p>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="file" id="edit_file"  class="px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md py-2 "/>
                                </div>
                                <p v-if="errors.file" class="mt-2 text-sm text-red-500">
                                    {{errors.file[0]}}
                                </p>
                        ...
                        <div class="px-4 py-3  text-right sm:px-6">
                            <button type="button" @click="update" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Guardar
                            </button>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        toEdit(product){
            ...
            this.edit             = product;
            this.edit.category_id = product.category.id;
        },
        ...
        update(){
            ...
            formData.append('min_price', this.edit.min_price ? this.edit.min_price :'');
            formData.append('stock', this.edit.stock ? this.edit.stock : '');
            formData.append('category_id', this.edit.category_id ? this.edit.category_id : '');
            formData.append('category_id', this.edit.category_id ? this.edit.category_id : '');
            formData.append('_method', 'PUT');

            Product.update(this.edit.id, formData, data => {
                this.index();
                this.errors = {};
                this.edit = {};
